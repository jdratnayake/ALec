...
class DisplaySessionsListModel extends Database
{
    ...
    {
        $query = "SELECT session_id, session_name, session.course_id, DATE_FORMAT(create_date, '%M %d %Y') AS date, course_name FROM session INNER JOIN course ON session.course_id=course.course_id WHERE lecturer_id='$userId' AND status='T' ORDER BY create_date DESC";
    ...
    {
        $query = "SELECT session_id, session_name, session.course_id, DATE_FORMAT(create_date, '%M %d %Y') AS date, course_name FROM session INNER JOIN course ON session.course_id=course.course_id WHERE lecturer_id='$userId' AND status='F' ORDER BY create_date DESC";
    ...
    public function getActiveSessionsSearch($userId, $searchValue)
    {
        ...
        $query = "SELECT session_id, session_name, session.course_id, DATE_FORMAT(create_date, '%M %d %Y') AS date, course_name FROM session INNER JOIN course ON session.course_id=course.course_id WHERE lecturer_id='$userId' AND status='T' AND session_name LIKE '$searchValue' ORDER BY create_date DESC";
    ...
    public function getNotActiveSessionsSearch($userId, $searchValue)
    {
        ...
        $query = "SELECT session_id, session_name, session.course_id, DATE_FORMAT(create_date, '%M %d %Y') AS date, course_name FROM session INNER JOIN course ON session.course_id=course.course_id WHERE lecturer_id='$userId' AND status='F' AND session_name LIKE '$searchValue' ORDER BY create_date DESC";
