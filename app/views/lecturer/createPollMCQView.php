            ...
            <form action="<?php echo BASEURL . "/createPoll/mcq/$sessionId" ?>" method="POST">
                ...
                <div class="content">
                    ...
                    <div class="mcq" id="div-mcq" style="display: none">
                        ...
                        <textarea class="session question" placeholder="Enter your question here..." name="question" id="question" rows="3"></textarea>
                        <div class="error"><?php echo $errors["question"]; ?></div>

                        <label for="answer-1"></label>
                        <input type="text" class="session" placeholder="Enter your answer here..." name="answer-1" id="answer-1">
                        <div class="error"><?php echo $errors["answer-1"]; ?></div>

                        <label for="answer-2"></label>
                        <input type="text" class="session" placeholder="Enter your answer here..." name="answer-2" id="answer-2">
                        <div class="error"><?php echo $errors["answer-2"]; ?></div>

                        <label for="answer-3"></label>
                        <input type="text" class="session" placeholder="Enter your answer here..." name="answer-3" id="answer-3">
                        <div class="error"><?php echo $errors["answer-3"]; ?></div>

                        <label for="answer-4"></label>
                        <input type="text" class="session" placeholder="Enter your answer here..." name="answer-4" id="answer-4">
                        <div class="error"><?php echo $errors["answer-4"]; ?></div>

                        <label for="answer-5"></label>
                        <input type="text" class="session" placeholder="Enter your answer here..." name="answer-5" id="answer-5">
                    ...
                    <div class="tf" id="div-tf" style="display: none">
                        <label for="question"></label>
                        <input type="text" class="session question" placeholder="Enter your question here..." name="tf-question" id="question">
                    ...
                    <div class="answer" style="width: 100%">
                        ...
                        <input type="text" class="session" placeholder="Enter correct answer here..." name="correct-answer" id="correct-answer" style="background-color: rgba(118,151,179,0.3)">
