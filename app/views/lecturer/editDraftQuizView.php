...
<body>
    ...
    <ul class="breadcrumb" style="margin-left: 5%">
        ...
        <li>
            <a href="<?php echo BASEURL . "/quizDraftComplete/index/" . $data["quizId"] ?>">
                Preview Draft Quiz
            </a>
        </li>
        <li>Edit Draft Quiz</li>
    </ul>
    ...
    <div class="form-content">
        ...
        <!-- Quiz basic details -->
        <form class="details" action="<?php echo BASEURL . "/quizDraftComplete/submit/{$data['quizId']}" ?>" method="post" id="form">
