...
<div class="form-content">
    ...
    <button type="button"
            onclick="<?php echo "location.href='" . BASEURL . "/editQuiz/index/{$data["quizDetails"]["quiz_id"]}" . "'"; ?>"
            class="edit"><i class="fa fa-pencil" aria-hidden="true"></i>Edit quiz
    </button>
    ...
    <div class="pub-button-container">
        <button id="publish-btn" type="submit" class="done">Publish</button>
        <button id="unpublish-btn" type="submit" class="done red-done" style="display: none">Unpublish</button>
    </div>
