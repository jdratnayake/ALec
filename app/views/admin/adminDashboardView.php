    ...
    <div id="create-users-model" class="modal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <button onclick="<?php echo "location.href=" . "'" . BASEURL . "/adminDashboard/download/1" . "'" ?>"
                        id="btn-create-download">Download template
                </button>
                ...
                <form action="<?php echo BASEURL . "/adminDashboard/submit" ?>" method="post"
            ...
            <div class="modal-body">
                <form action="<?php echo BASEURL . "/adminDashboard/manageCourseParticiption" ?>" method="post"
                    ...
                    <div class="modal-body enrollment-file-upload" id="file-mode-div" style="display: none;">
                        <p>Use this format to enter details using .csv file</p>
                        <button onclick="<?php echo "location.href=" . "'" . BASEURL . "/adminDashboard/download/3" . "'" ?>"
                                id="btn-create-download-enrollment">Download template
                        </button>
