...
<div class="wrapper center">
    ...
    <div class="form-container">
        ...
        <div class="form-inner">
            ...
            <!-- FORM START -->
            <form method="post" action="<?php echo BASEURL . '/addNewCourse/index'; ?>" class="login" id="registerForm"
                ...
                <div class="field-long">
                    ...
                    <textarea placeholder="Course Description" name="c_desc" id="c_desc" rows="10" cols="30"
                              onfocusout="validateCourseDescription()"></textarea>
