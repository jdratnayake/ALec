...
<body>
    ...
    <div class="form-content">
        ...
        <!-- Quiz basic details -->
        <form class="details" method="post" id="form" action="<?php echo BASEURL . '/temp/submit'; ?>">
            <ol class="all-questions">
                ...
                <li class='question-container'>
                    <div class='single-choice'>
                        ...
                        <ol>
                            <div class='answer'>
                                <input type='radio' id='scq-answer-1' name='q1'>
                                <label for='scq-answer-1'>
                                    <li>Windows</li>
                                </label>
                            </div>
                            <div class='answer'>
                                <input type='radio' id='scq-answer-2' name='q1'>
                                <label for='scq-answer-2'>
                                    <li>Linux</li>
                                </label>
                            </div>
                            <div class='answer'>
                                <input type='radio' id='scq-answer-3' name='q1'>
                                <label for='scq-answer-3'>
                                    <li>Oracle</li>
                                </label>
                            </div>
                            <div class='answer'>
                                <input type='radio' id='scq-answer-4' name='q1'>
                ...
                <li class='question-container'>
                    <div class='multiple-choice'>
                        ...
                        <ol>
                            ...
                            <div class='answer'>
                                <input type='checkbox' id='mcq-answer-2' name='q22' value='ans-2'>
                ...
                <li class='question-container'>
                    <div class='short-ans'>
                        ...
                        <input type='text' id='short-answer-box' name="short">
                    </div>
                </li>
            </ol>
