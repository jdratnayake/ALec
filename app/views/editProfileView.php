...
<div class="details-content">
    ...
    <div class="user-details-container">
        ...
        <div class="button-container">
            ...
            <form action="<?php echo BASEURL . "/editProfile/upload" ?>" method="post" enctype="multipart/form-data"
                    ...
                    <div class="pvt-details">
                        ...
                        <span class="form-group">
                            ...
                            <input type="text" id="fName" name="fName"
                                   value="<?php echo $data["userDetails"]["first_name"]; ?>" class="" disabled>
                        </span>
                        <span class="form-group">
                            <label for="lName">Last Name :</label>
                            <input type="text" id="lName" name="lName"
                                   value="<?php echo $data["userDetails"]["last_name"]; ?>" class="" disabled>
                        </span>
                        <span class="form-group">
                            <label for="email">Email :</label>
                            <input type="text" id="email" name="email"
                                   value="<?php echo $data["userDetails"]["email"]; ?>" class="" disabled>
                        </span>
                        <span class="form-group">
                            <label for="tele">Tele. No :</label>
                            <input type="text" id="tele" name="tele" value="<?php echo $data["userDetails"]["tele"]; ?>"
                                   class="" disabled>
                        </span>
                        ...
                        <div class="save-buttons">
                            ...
                            <button id="btn-cancel" type="reset" value="Cancel" class="buttons cancel"
                                    style="display: none">
