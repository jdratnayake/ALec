...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 28, 2021 at 06:04 AM
...
(4, 'Temp Automata', 'T', NULL, '2021-12-22 11:04:22', 883, 72),
...
INSERT INTO `session_answer` (`choice_id`, `question_no`, `session_id`, `choice_name`) VALUES
(11, 5, 5, 'Windows'),
(12, 5, 5, 'Linux'),
(13, 5, 5, 'Oracle'),
(14, 5, 5, 'DOS');
...
INSERT INTO `session_question` (`question_no`, `session_id`, `question_type`, `question`, `status`, `published_time`, `duration`) VALUES
(5, 5, 'mcq', 'Which of the following is not an operating system?', 'F', '2021-12-28 10:26:51', '00:02:00');
...
--
ALTER TABLE `session_answer`
  MODIFY `choice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
