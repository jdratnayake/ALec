...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 14, 2021 at 05:21 PM
...
(13, 'Will MAC addresses run out?', 'Will MAC addresses run out?\r\n\r\nMAC address is 48-bits in length and can provide 281.5 trillion addresses. This means that is highly unlikely for us to run out of MAC addresses anytime soon in the future.\r\n\r\nIf we run out of all possible MAC addresses, is it possible to have duplicates? ', '2021-10-13 11:59:06', 19, 13, NULL, '2021-10-13 11:59:06'),
(14, 'If we use TDM for store-and-forward traffic', 'This is regarding the question in the exercises given in Dr.Nalin Ranasinghe\'s slides.\r\n\r\nTo my understanding, in TDM we use packet switching. Hence this reduces the delay between the sender and the receiver since the first packet from a long message can be forwarded before the second one has fully arrived. \r\n\r\nIf we use FDM, then according to store-and-forward transmission, the long message should arrive fully before sending it to the receiver\'s end. Forwarding a packet such as in the first case is not possible here. ', '2021-10-13 12:00:36', 19, 78, NULL, '2021-10-13 12:00:36'),
(15, 'What is you name?', 'My Name is Janitha Devin Ratnayake', '2021-10-13 13:14:41', 19, 13, NULL, '2021-10-13 13:14:41');
...
(119, 74, 69, 'Pradeep', 50),
(120, 74, 69, 'Kumara', 50),
(121, 75, 69, 'Dulitha', 100),
(122, 76, 69, 'ICT', 0),
(123, 76, 69, 'Physics', 100);
...
(66, 'Operating System MCQ Part 1', 'publish', '2021-10-04 08:41:12', '2021-10-14 16:00:00', '2021-10-15 16:00:00', '00:50:00', 13, 11),
...
(50, 69, 'What is the capital city of Sri Lanka?', 'mcq-s', 0),
...
(74, 69, 'Father name?', 'mcq-m', 0),
(75, 69, 'Brother Name?', 'mcq-s', 0),
(76, 69, 'Favorite subject?', 'mcq-s', 0);
...
(8, 'admin', 'admin', 'admin@gmail.com', '0112691411', '$2y$10$rEc8oEWtCCp0xTq8J7A/Au8v3RgvubuZHrTGBw2/1VgDxFoX01pEu', 'admin', NULL),
(9, 'Dinuni', 'Fernando', 'dkf@ucsc.cmb.ac.lk', '0362255456', '$2y$10$kqcUj5djbW1xrsstKvHP/e18lq.Jbfj1I/GHWlRz7v0UdGBbcS1Ga', 'lec', NULL),
(10, 'Hirasha', 'Pooliyadda', 'hsp@ucsc.cmb.ac.lk', '0712193599', '$2y$10$zZQ/bgFrgUk8NHAOlhYbxe/0NfMvPjypHl/C48FItuYF3tMtkH/0q', 'lec', NULL),
(12, 'Charith', 'Anjana', 'ch@gmail.com', '0766455833', '$2y$10$w6UXM9qmb6WHOh9MpSxLGOSn6NOzDCf5/6Ruy8RKcFI7s/knXk.rW', 'stu', NULL),
(13, 'Thilina', 'Halloluwaa', 'tch@ucsc.cmb.ac.lk', '0765282977', '$2y$10$HpueGS4UPwZ/i8taKMvEsewWU1LOUiG5rSnHfxwAzsmJkYftz89e6', 'lec', '13.jpeg'),
...
(26, 'Dulitha', 'Ratnayake', 'janithadevinratnayake@gmail.com', NULL, '$2y$10$/hnHE3xlCZlB47khsAArpe2dvvPKya9TpZ80WJPIkqQnArw1w56BC', 'lec', NULL),
...
--
ALTER TABLE `forum`
  MODIFY `forum_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `question_choice`
  MODIFY `choice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=124;
...
--
ALTER TABLE `quiz_question`
  MODIFY `question_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
