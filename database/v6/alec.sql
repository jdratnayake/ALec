...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 23, 2022 at 08:06 PM
...
(384, 211, 137, '?', 100),
(385, 211, 137, '?', -20),
(386, 211, 137, 'None of the mentioned', -20),
(387, 212, 137, 'False', 100),
...
(137, 'Quiz 1', 'create', '2022-03-23 23:56:56', NULL, NULL, '00:05:00', 883, 34),
...
(210, 137, 'In Moore machine, output is produced over the change of:', 'mcq-s', 0),
(211, 137, 'The output alphabet can be represented as:', 'mcq-s', 0),
(212, 137, 'State true or false:\r\nStatement:In mealy machine, the O/P depends only upon State?', 'short ans', 0),
(213, 138, 'An NFA’s transition function returns', 'mcq-s', 0),
(214, 138, 'Conversion of a DFA to an NFA', 'mcq-s', 0),
(215, 138, 'The subset construction shows that every NFA accepts a', 'mcq-s', 0),
(216, 138, 'Which is the application of NFA', 'mcq-s', 0),
(217, 138, 'Which one is a FALSE statement?', 'mcq-s', 0),
(218, 138, 'Which of the following statement is true?', 'mcq-s', 0),
(219, 138, 'Grammars that can be translated to DFAs :', 'mcq-s', 0),
...
(20, 'Inducers', 'T', 'F', NULL, '2022-03-27 00:14:14', 883, 72);
...
(32, 20, 20, 'Input Variations', 0),
(33, 20, 20, 'Both', 0),
(34, 20, 20, 'None of the mentioned', 0),
...
(21, 'How Moore and Mealy machine works in Computer Memory what is their importance in Computing ?', 6, '2022-03-24 00:19:26', 20, 1494, 'T', 0),
(22, 'What is the difference between an Alphabet and an element of a set.  Whether Alphabet is an element of a set or it is a set itself?', 11, '2022-03-24 00:19:48', 20, 1494, 'T', 0),
...
(20, 20, 'mcq', 'The major difference between Mealy and Moore machine is about:', 'Output Variations', 'F', NULL, '00:02:00', 0, 0),
(21, 20, 'mcq', 'Which one among the following is true?\r\nA mealy machine', 'has less circuit delays', 'F', NULL, '00:01:00', 0, 0),
(22, 20, 'mcq', 'Which of the following does not belong to input alphabet if S={a, b}* for any language?', 'e', 'F', NULL, '00:01:00', 0, 0),
(23, 20, 'open', 'The password to the admins account=”administrator”. The total number of states required  to make a password-pass system using DFA would be __________', '14', 'F', NULL, '00:02:00', 0, 0),
(24, 20, 'open', 'An automaton that presents output based on previous state or current input:', 'Transducer', 'F', NULL, '00:02:00', 0, 0);
...
--
ALTER TABLE `badge`
  MODIFY `badge_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=312;
...
--
ALTER TABLE `forum_reply`
  MODIFY `reply_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
...
--
ALTER TABLE `question_choice`
  MODIFY `choice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=451;
...
--
ALTER TABLE `quiz_question`
  MODIFY `question_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=231;
...
--
ALTER TABLE `session_answer`
  MODIFY `choice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
...
--
ALTER TABLE `session_question`
  MODIFY `question_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
