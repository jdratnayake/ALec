...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 27, 2021 at 12:34 PM
...
(47, 'OS Quiz 1', 'false', '2021-09-27 15:48:26', NULL, NULL, '00:30:00', 13, 10);
...
(11, 47, 'Which of the following is not an operating system?', 'mcq', 0),
(12, 47, 'What is the maximum length of the filename in DOS?', 'mcq', 0);
...
--
ALTER TABLE `quiz`
  MODIFY `quiz_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
