...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 01, 2022 at 11:36 AM
...
(59, 'Hish gfdgdf', 'gggg', 0, '2021-12-26 19:37:13', 28, 1497, 'T', NULL, '2021-12-26 19:37:13');
...
(5, 'Temp OS', 'T', NULL, '2021-12-22 11:04:37', 883, 60);
...
(5, 5, 'mcq', 'Which of the following is not an operating system?', 'F', NULL, '00:02:00', 1);
...
(1498, 'Rukmal', 'Ratnayake', 'pradeepratnayake58@gmail.com', NULL, '$2y$10$0DKd7w67sZ2zq3DqGscaeebgCpatPHlQrOHIgQo98MBZJIfESYE/a', 'stu', '0', NULL);
...
--
ALTER TABLE `session_question`
  MODIFY `question_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `user`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1499;
...
-- Events
--
CREATE DEFINER=`root`@`localhost` EVENT `session_question_event_5_7` ON SCHEDULE AT '2021-12-31 19:14:55' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE session_question SET status='F' WHERE question_no='7'$$

CREATE DEFINER=`root`@`localhost` EVENT `session_question_event_5_6` ON SCHEDULE AT '2022-01-01 12:03:52' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE session_question SET status='F' WHERE question_no='6'$$

CREATE DEFINER=`root`@`localhost` EVENT `session_question_event_5_8` ON SCHEDULE AT '2022-01-01 15:34:26' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE session_question SET status='F' WHERE question_no='8'$$

CREATE DEFINER=`root`@`localhost` EVENT `session_question_event_5_9` ON SCHEDULE AT '2022-01-01 15:39:07' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE session_question SET status='F' WHERE question_no='9'$$
