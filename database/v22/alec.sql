...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 12, 2021 at 03:34 PM
...
(54, 56, 'Is this correct?', 1, '2021-12-12 14:44:16', 1497, 'T');
...
(54, 'If we use TDM for store-and-forward traffic, would the overall trunk utilization efficiency fall?', 'Network', 1, '2021-12-12 14:43:08', 28, 1497, 'T', 56, '2021-12-12 14:44:16');
...
--
ALTER TABLE `forum_reply`
  MODIFY `reply_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
