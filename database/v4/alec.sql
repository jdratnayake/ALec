...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 23, 2022 at 01:20 PM
...
(31, 72, 883, 'Temp', ''),
(32, 51, 883, 'Test 1', 'this is a testing topic name'),
(33, 51, 883, 'Test 2', '');
...
(358, 195, 127, 'Janitha', 100),
(359, 196, 128, 'Input/output control program', -25),
(360, 196, 128, 'Job control program', -25),
(361, 196, 128, 'Supervisor', -25),
(362, 196, 128, 'Performance monitor', 100),
(363, 197, 128, 'Software routines', 50),
(364, 197, 128, 'Input-output devices', 0),
(365, 197, 128, 'Hardware components', 50),
(366, 197, 128, 'All of these', 0),
(367, 198, 128, 'Real time system', 100),
(368, 199, 128, 'can run on PC’s and larger system', 33),
(369, 199, 128, 'is multitasking', 33),
(370, 199, 128, 'is multiuser', 33),
(371, 200, 130, 'Interrupt servicing', 0),
(372, 200, 130, 'Interrupt handling', 100),
(373, 200, 130, 'Polling', 0),
(374, 200, 130, 'Spooling', 0),
(375, 202, 130, 'A graphic display device', 100),
(376, 208, 132, 'Answer 1', 0),
(377, 208, 132, 'Answer 2', 0),
(378, 208, 132, 'Answer 3', 100);
...
(121, 'Quiz 1', 'publish', '2021-11-11 18:21:25', '2022-03-23 14:41:00', '2022-04-07 14:40:00', '00:10:00', 883, 31),
...
(188, 121, 'Data types of the python?', 'mcq-m', 0),
...
(193, 122, '', 'mcq-s', 0),
(194, 122, '', 'mcq-s', 0),
(195, 127, 'What is your name?', 'short ans', 0),
(196, 128, 'Which of the following Is not a part of the operating system?', 'mcq-s', 0),
(197, 128, 'Operating system is a collection of', 'mcq-m', 0),
(198, 128, 'What is the name of the operating system that reads and reacts in terms of actual time?', 'short ans', 0),
(199, 128, 'UNIX operating system', 'mcq-m', 0),
(200, 130, 'Context switching is part of', 'mcq-s', 0),
(201, 130, '', '', 0),
(202, 130, 'Which of the following is an example of a spooled device?', 'short ans', 0),
(203, 130, '', 'mcq-s', 0),
(204, 132, '', 'mcq-s', 0),
(205, 132, '', 'mcq-s', 0),
(206, 132, '', 'mcq-s', 0),
(208, 132, 'Question 1', 'mcq-s', 0);
...
(7, 'Temp OS', 'T', 'T', NULL, '2022-01-01 16:39:35', 883, 60),
(9, 'OS File Systems', 'F', 'T', NULL, '2022-01-05 16:21:11', 883, 60),
(11, 'Lab R', 'F', 'T', NULL, '2022-01-05 16:21:56', 883, 51),
(12, 'Lab Octave', 'F', 'T', NULL, '2022-01-05 16:22:10', 883, 51),
(13, 'AT NFA', 'F', 'T', NULL, '2022-01-05 19:47:27', 883, 72),
(14, 'Test new today', 'F', 'T', NULL, '2022-03-19 16:26:50', 883, 60);
...
(21, 13, 7, 'Finite automata without input', 3),
(22, 13, 7, 'Finite automata with output', 1),
(23, 13, 7, 'Non Finite automata with output', 0),
(24, 13, 7, 'None of the mentioned', 2),
(25, 15, 7, 'Input/output control program', 0),
(26, 15, 7, 'Job control program', 0),
(27, 15, 7, 'Supervisor', 0),
(28, 15, 7, 'Performance monitor', 0),
(29, 16, 7, 'TRUE', 0),
(30, 16, 7, 'FALSE', 0);
...
(18, 'I\'m Janitha Random', 1, '2022-01-05 21:34:52', 7, 1497, 'T', 1),
(19, 'I\'m Janitha Real', 1, '2022-01-05 21:34:59', 7, 1497, 'F', 0),
(20, 'Pansilu Real', 1, '2022-01-05 21:36:59', 7, 1494, 'F', 0);
...
(1494, 18, '2022-03-17 13:56:46'),
(1494, 19, '2022-03-17 13:55:09'),
(1494, 20, '2022-01-06 14:46:46');
...
(17, 1497, 14, 'JANITHA', '2022-01-06 15:00:24');
...
(13, 7, 'mcq', 'Moore Machine is an application of:', 'Nothing', 'F', '2022-01-06 19:37:54', '00:03:00', 6, 0),
(14, 7, 'open', 'What is your name?', 'Janitha Devin Ratnayake', 'F', '2022-01-06 15:00:18', '00:00:30', 7, 0),
(15, 7, 'mcq', 'Which of the following Is not a part of the operating system?', 'Performance monitor', 'F', NULL, '00:02:00', 0, 0),
(16, 7, 'mcq-tf', 'Does Alan Turing the father of the computer?', 'True', 'F', NULL, '00:01:00', 0, 0),
(17, 7, 'open', 'FIFO scheduling is', 'Non-preemptive scheduling', 'F', NULL, '00:03:00', 0, 0),
(18, 13, 'open', 'What is your hobby?', 'Play Cricket', 'F', NULL, '00:05:00', 0, 0),
(19, 14, 'open', 'Basi? Ranil?', 'Ranil', 'F', NULL, '00:01:00', 0, 0);
...
CREATE TABLE `student_marks_log` (
  `id` int(11) NOT NULL,
  `student_id` int(11) NOT NULL,
  `unique_ids` varchar(50) NOT NULL,
...
--
ALTER TABLE `question_choice`
  MODIFY `choice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=379;

--
-- AUTO_INCREMENT for table `quiz`
--
ALTER TABLE `quiz`
  MODIFY `quiz_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;

--
-- AUTO_INCREMENT for table `quiz_question`
--
ALTER TABLE `quiz_question`
  MODIFY `question_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=210;
...
--
ALTER TABLE `session_open_attempt`
  MODIFY `attempt_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `session_question`
--
ALTER TABLE `session_question`
  MODIFY `question_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
