...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 19, 2021 at 10:18 AM
...
(17, 'What is the difference between #include <filename> and #include \"filename\"?', 'In the C and C++ programming languages, what is the difference between using angle brackets and using quotes in an include statement, as follows?\r\n\r\n#include <filename>\r\n#include \"filename\"', '2021-10-18 15:41:00', 3, 101, NULL, '2021-10-18 15:41:00'),
(18, 'How to initialize a struct in accordance with C programming language standards', 'I want to initialize a struct element, split in declaration and initialization. This is what I have:\r\n\r\ntypedef struct MY_TYPE {\r\n  bool flag;\r\n  short int value;\r\n  double stuff;\r\n} MY_TYPE;\r\n\r\nvoid function(void) {\r\n  MY_TYPE a;\r\n  ...\r\n  a = { true, 15, 0.123 }\r\n}\r\nIs this the way to declare and initialize a local variable of MY_TYPE in accordance with C programming language standards (C89, C90, C99, C11, etc.)? Or is there anything better or at least working?', '2021-10-18 15:42:07', 3, 101, NULL, '2021-10-18 15:42:07');
