...
(51, 53, 'Hi', 0, '2021-12-12 11:48:58', 1497, 'T'),
(51, 54, 'Bye', 0, '2021-12-12 11:49:25', 1497, 'F'),
(52, 55, 'Bye', 0, '2021-12-12 11:53:04', 883, 'F');
...
(51, 'If we use TDM for store-and-forward traffic, would the overall trunk utilization efficiency fall?', 'Hi 1', 0, '2021-12-12 11:48:38', 28, 883, 'F', 54, '2021-12-12 11:49:25'),
(52, 'what123', 'Hi I\'m the lecturer', 0, '2021-12-12 11:52:39', 28, 883, 'F', 55, '2021-12-12 11:53:04');
...
(22, '1', 'Lec ALec started a new forum discussion', 'SCS 2212 - Automata Theory', 'http://localhost/ALec/studentForumTopicDiscussion/index/51', '2021-12-12 11:48:38'),
(23, '1', 'Lec ALec started a new forum discussion', 'SCS 2212 - Automata Theory', 'http://localhost/ALec/lecturerForumTopicDiscussion/index/51', '2021-12-12 11:48:38'),
(24, '1', 'Thor\r\n London\r\n replied to forum disscussion', 'SCS 2212 - Automata Theory', 'http://localhost/ALec/studentForumTopicDiscussion/index/51', '2021-12-12 11:48:58'),
(25, '1', 'Thor\r\n London\r\n replied to forum disscussion', 'SCS 2212 - Automata Theory', 'http://localhost/ALec/lecturerForumTopicDiscussion/index/51', '2021-12-12 11:48:58'),
(26, '1', 'Janitha Ratnayake replied to forum disscussion', 'SCS 2212 - Automata Theory', 'http://localhost/ALec/studentForumTopicDiscussion/index/51', '2021-12-12 11:49:25'),
(27, '1', 'Janitha Ratnayake replied to forum disscussion', 'SCS 2212 - Automata Theory', 'http://localhost/ALec/lecturerForumTopicDiscussion/index/51', '2021-12-12 11:49:25'),
(28, '1', 'Lec ALec started a new forum discussion', 'SCS 2212 - Automata Theory', 'http://localhost/ALec/studentForumTopicDiscussion/index/52', '2021-12-12 11:52:39'),
(29, '1', 'Lec ALec started a new forum discussion', 'SCS 2212 - Automata Theory', 'http://localhost/ALec/lecturerForumTopicDiscussion/index/52', '2021-12-12 11:52:39'),
(30, '1', 'Lec ALec replied to forum disscussion', 'SCS 2212 - Automata Theory', 'http://localhost/ALec/studentForumTopicDiscussion/index/52', '2021-12-12 11:53:04'),
(31, '1', 'Lec ALec replied to forum disscussion', 'SCS 2212 - Automata Theory', 'http://localhost/ALec/lecturerForumTopicDiscussion/index/52', '2021-12-12 11:53:04');
...
(1494, 'Pansilu', 'Gunaratne', 'pansilugunaratne8@gmail.com', NULL, '$2y$10$Oq.cjz24D0XTmimgr6tW7uoA3ug7Rh4bYKVZBTX18.wBTo.kPJx6O', 'stu', '1', NULL),
(1495, 'Anuruddha', 'Ratnayake', 'dulitharatnayakestock@gmail.com', NULL, '$2y$10$sIcalrIdiYCMdNmUqXuoOeG7F8P0jexE2TcS.9azwaAye6GR16lUe', 'lec', '0', NULL),
(1496, 'Madhubahashini', 'Ratnayake', 'jdevinratnayakecse@gmail.com', NULL, '$2y$10$sa6pvpyqU4uz0YcmBr7jwObvm7oWtnMb1WMNEIWHsToWmQHZ01KxW', 'stu', '0', NULL),
...
--
ALTER TABLE `badge`
  MODIFY `badge_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;
...
--
ALTER TABLE `forum_reply`
  MODIFY `reply_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
...
--
ALTER TABLE `question_choice`
  MODIFY `choice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=354;
...
--
ALTER TABLE `quiz_question`
  MODIFY `question_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=190;

--
-- AUTO_INCREMENT for table `tag`
--
ALTER TABLE `tag`
  MODIFY `tag_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;

--
-- AUTO_INCREMENT for table `user`
--
ALTER TABLE `user`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1498;
