...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 01, 2021 at 01:03 PM
...
(27, 'Janitha', 'Ratnayake', 'janithadevin@gmail.com', NULL, '$2y$10$Glkr6fpDp6BGqSUZKZtrHeuDq9mQ2U1CHI76YEAC.ZoyN.GlNso4i', 'stu');
...
--
ALTER TABLE `question_choice`
  MODIFY `choice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
...
--
ALTER TABLE `quiz_question`
  MODIFY `question_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
