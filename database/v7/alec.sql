...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 26, 2022 at 01:36 PM
...
(1497, 311, 883, '2022-03-24 08:36:22');
...
(137, 'Quiz 1', 'publish', '2022-03-23 23:56:56', '2022-03-25 22:45:00', '2022-03-31 22:45:00', '00:10:00', 883, 34),
(138, 'Quiz 2', 'publish', '2022-03-23 23:58:07', '2022-03-26 15:37:00', '2022-03-31 15:36:00', '00:10:00', 883, 34),
...
(1497, 137, '2022-03-26 15:34:31', 100),
...
(210, 137, 'In Moore machine, output is produced over the change of:', 'mcq-s', 100),
(212, 137, 'State true or false:Statement:In mealy machine, the O/P depends only upon State?', 'mcq-s', 100),
...
(20, 'Inducers', 'T', 'T', NULL, '2022-03-27 00:14:14', 883, 72);
...
(1497, 20, 31, '2022-03-24 08:27:16');
...
(20, 20, 'mcq', 'The major difference between Mealy and Moore machine is about:', 'Output Variations', 'F', '2022-03-26 09:23:58', '00:02:00', 1, 0),
...
(8, 1497, 'quiz', '100.00', '2022-03-26 15:34:40'),
...
--
ALTER TABLE `course_topic`
  MODIFY `topic_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `forum`
  MODIFY `forum_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
...
--
ALTER TABLE `question_choice`
  MODIFY `choice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=452;

--
-- AUTO_INCREMENT for table `quiz`
--
ALTER TABLE `quiz`
  MODIFY `quiz_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=148;

--
-- AUTO_INCREMENT for table `quiz_question`
--
ALTER TABLE `quiz_question`
  MODIFY `question_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=237;
...
--
ALTER TABLE `session_open_attempt`
  MODIFY `attempt_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
